    ...
    <div className="premium-properties-main min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 py-10 px-4" id="why-choose-us">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10 animate-fade-in why-choose-header">
          <h2 className="text-3xl mobile-title-text font-[Montserrat] sm:text-xl md:text-5xl font-black mb-3 sm:mb-4 bg-gradient-to-r from-black via-[#474236] to-[#c99913] bg-clip-text text-transparent animate-pulse">
            Why Choose Us?
          </h2>
          <div className="h-1 bg-gradient-to-r from-transparent via-[#c99913] to-transparent rounded-full animate-pulse"></div>
          <p className="text-xl mobile-subtitle-text font-bebas md:text-2xl text-gray-600 font-light max-w-4xl mx-auto leading-relaxed whychoose-subtitle">
        ...
        <div className="text-center mt-20 animate-fade-in-up bottom-cta" style={{ animationDelay: '600ms' }}>
          <div className="bottom-whychoose-content inline-flex items-center space-x-4 bg-white  px-8 py-3 shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 gradient-border">
