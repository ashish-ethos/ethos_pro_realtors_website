        ...
        <div className="flex overflow-x-auto sm:flex-wrap justify-start sm:justify-center gap-2 sm:gap-4 p-2 bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg scrollbar-hidden">
          {tabs.map((tab) => (
            <CustomButton
              ...
              className={`px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold transition-all cursor-pointer duration-300 transform hover:scale-105 text-sm sm:text-base whitespace-nowrap border-2 border-transparent ${activeTab === tab.key
                ? 'gradient-border-active text-[#c99913] font-bold bg-[#c99913]/10 shadow-xl scale-105'
                : 'text-gray-600 hover:gradient-border-active hover:text-[#c99913] border-black border-1'
                }`}
            >
              {tab.label}
              <span
