        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              {/* View Toggle */}
              <div className="flex bg-[#555] border-1 border-[#ffffff38] rounded-xl shadow-sm p-1">
                <Button
                ...
                <div className="custom-scrollbar space-y-3 sm:space-y-4 px-2 max-h-[calc(100vh-200px)] sm:max-h-[calc(100vh-250px)] overflow-y-auto scrollbar-thin scrollbar-thumb-[#c2c6cb] scrollbar-track-[#555]">
                  {filteredPosts.length === 0 ? (
                    ...
                    (searchTerm.trim() || filterCategory !== "all"
                      ...
                      <div
                        key={post.id}
                        className={`group relative p-3 sm:p-4 rounded-xl sm:rounded-2xl border-1 cursor-pointer border-1 transition-all duration-300 hover:shadow-lg hover:scale-[1.01] hover:border-[#c08830] ${
                      ...
                      >
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4
                              className={`font-semibold text-sm sm:text-base leading-snug mb-2 line-clamp-2 ${
                                selectedPost.id === post.id
                                  ? "text-[#c2c6cb]"
                                  : "text-[#c2c6cb]"
                              }`}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 w-full">
              {filteredPosts.length === 0 ? (
                ...
                (searchTerm.trim() || filterCategory !== "all"
                  ...
                  <div
                    key={post.id}
                    className={`group relative p-3 sm:p-4 rounded-xl sm:rounded-2xl cursor-pointer transition-all duration-300 hover:shadow-lg border-1 hover:scale-[1.01] hover:border-[#c08830] ${
                      hoveredPost === post.id
                  ...
                  >
                    ...
                    <h4
                      className={`font-semibold text-xs sm:text-sm leading-tight mb-1 sm:mb-2 line-clamp-2 ${
                        hoveredPost === post.id ? "text-[#c2c6cb]" : "text-[#c2c6cb]"
                      }`}
                    >
                      {post.title}
                    </h4>
