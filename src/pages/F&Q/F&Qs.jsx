...
const FAQPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 border-1 border-gray-200 rounded-lg shadow-lg bg-white">
      <h1 className="text-4xl font-bold text-center mb-6 ">Frequently Asked Questions</h1>

      {Object.entries(faqs).map(([category, items]) => (
        <div key={category} className="mb-10">
          <h2 className="text-2xl font-semibold mb-6 capitalize text-gray-800 border-b pb-2">
            FAQs About {category}
          </h2>
          ...
          <div className="space-y-4">
            {items.map((faq, idx) => {
              ...
              return (
                <div
                  key={key}
                  className="border-gray-400 border-1 rounded-xl shadow-sm overflow-hidden bg-white"
                >
                  <button
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`w-5 h-5 text-gray-500 cursor-pointer transition-transform ${
                        isOpen ? "rotate-180" : ""
                      }`}
                    />
                  </button>
